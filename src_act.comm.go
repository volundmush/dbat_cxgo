...
func do_languages(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if config_info.Play.Enable_languages != 0 {
		...
		if arg[0] == 0 {
			...
			for i = SKILL_LANG_COMMON; i <= SKILL_LANG_DRACONIC; i++ {
				if search_block(&arg[0], &languages[0], 0) == i-SKILL_LANG_COMMON && GET_SKILL(ch, i) != 0 {
...
func do_osay(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if *argument == 0 {
		...
		act(&buf2[0], 0, ch, nil, nil, TO_ROOM)
	}
}
func do_say(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if *argument == 0 {
		...
		if sch == nil {
			...
			act(&buf2[0], 1, ch, nil, unsafe.Pointer(sch), TO_VICT)
			act(&buf[0], 1, ch, nil, unsafe.Pointer(sch), TO_NOTVICT)
		}
			...
			if SHENRON == 1 {
				if int(libc.BoolToInt(GET_ROOM_VNUM(ch.In_room))) == DRAGONR && int(libc.BoolToInt(GET_ROOM_VNUM(EDRAGON.In_room))) == DRAGONR {
					if libc.StrStr(argument, libc.CString("wish")) != nil {
						...
						if granted == 0 && libc.StrStr(argument, libc.CString("knowledge")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s now has more knowledge!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a knowledge wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("speed")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now faster!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a speed wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("tough")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now tougher!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a tough wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("strength")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s has more strength!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a strength wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("intelligence")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now smarter!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a intelligence wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("wisdom")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now wiser!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a wisdom wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("agility")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now more agile!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a agility wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("constitution")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s has more guts!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a constitutionwish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("skill")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s has more skill!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a skill wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("power")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish cannot be granted, You might want to try something else instead, mortal!@w'@n\r\n"))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("money")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s now has become richer!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a money wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("immunity")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s now has immunity to Burn, Freezing, Mind Break, Poison, Blindness, Yoikominminken, and Paralysis!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a immunity wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("vitality")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish cannot be granted, You might want to try something else instead, mortal!%s@w'@n\r\n"))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("revive")) != nil {
							var count int = 0
							if wch != nil {
								count += 1
							}
							...
							if count == 1 {
								if !AFF_FLAGGED(wch, AFF_SPIRIT) {
									send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@C%s is not dead, and can not be revived.@w'@n\r\n"), GET_NAME(wch))
								} else {
									send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s has returned to life!%s@w'@n\r\n"), GET_NAME(wch), func() string {
										if WISH[0] != 0 {
											return ""
										}
										return " Now make your second wish."
									}())
									if real_room(wch.Droom) == int(-1) {
										wch.Droom = 300
									}
									if real_room(wch.Droom) != int(-1) {
										char_from_room(wch)
									...
									granted = 1
									SELFISHMETER -= 2
									mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a revive wish on %s."), GET_NAME(ch), GET_NAME(wch))
								}
							}
							if count == 2 {
								if !AFF_FLAGGED(wch, AFF_SPIRIT) {
								...
								if !AFF_FLAGGED(wch2, AFF_SPIRIT) {
									...
									send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s and %s have returned to life!%s@w'@n\r\n"), GET_NAME(wch), GET_NAME(wch2), func() string {
										if WISH[0] != 0 {
											return ""
										}
										return " Now make your second wish."
									...
									granted = 1
									SELFISHMETER -= 3
									mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a revive wish on %s."), GET_NAME(ch), GET_NAME(wch2))
									WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
								}
							}
							if count == 3 {
								...
								if !AFF_FLAGGED(wch3, AFF_SPIRIT) {
									...
									send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s, %s, and %s have returned to life!!%s@w'@n\r\n"), GET_NAME(wch), GET_NAME(wch2), GET_NAME(wch3), func() string {
										if WISH[0] != 0 {
											return ""
										}
										return " Now make your second wish."
									...
									granted = 1
									SELFISHMETER -= 3
									mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a revive wish on %s and %s."), GET_NAME(ch), GET_NAME(wch2), GET_NAME(wch3))
									WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
								}
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("immortal")) != nil && WISH[0] == 0 {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now immortal!@w'@n\r\n"), GET_NAME(wch))
								SET_BIT_AR(wch.Act[:], PLR_IMMORTAL)
								WISH[0] = 1
								WISH[1] = 1
								granted = 1
								SELFISHMETER += 4
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a immortal wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("immortal")) != nil && WISH[0] == 1 {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CI can not grant that wish, there is not enough remaining power in this summoning!@w'@n\r\n"))
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString(" mortal")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s is now mortal!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 4
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a mortal wish on %s."), GET_NAME(ch), GET_NAME(wch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("senzu")) != nil {
							if wch != nil {
								...
								obj = read_object(1, VIRTUAL)
								obj_to_char(obj, ch)
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s now possesses 10 senzus!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								SELFISHMETER += 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a senzu wish."), GET_NAME(ch))
							}
						}
						if granted == 0 && libc.StrStr(argument, libc.CString("roleplay")) != nil {
							if wch != nil {
								send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CYour wish has been granted, %s!%s@w'@n\r\n"), GET_NAME(wch), func() string {
									if WISH[0] != 0 {
										return ""
									}
									return " Now make your second wish."
								...
								granted = 1
								mudlog(NRM, ADMLVL_GOD, 1, libc.CString("Shenron: %s has made a roleplay wish."), GET_NAME(ch))
								WAIT_STATE(ch, (int(1000000/OPT_USEC))*4)
							}
						}
						if granted == 1 {
							...
							send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CThat person does not exist, make another wish.'@n\r\n"))
						} else {
							send_to_room(real_room(DRAGONR), libc.CString("@wShenron says, '@CDo not waste my time with wishes I can not grant...@w'@n\r\n"))
						}
					}
				}
			}
	...
	if SHENRON == 0 || SHENRON == 1 && ch.In_room != real_room(DRAGONR) {
	...
	if *argument == 0 {
		...
		if AFF_FLAGGED(k, AFF_GROUP) && k != ch && AWAKE(k) {
			if config_info.Play.Enable_languages != 0 {
				...
				act(&blah[0], 1, ch, nil, unsafe.Pointer(k), TO_VICT)
			}
		}
		for f = k.Followers; f != nil; f = f.Next {
			if AFF_FLAGGED(f.Follower, AFF_GROUP) && f.Follower != ch && AWAKE(f.Follower) {
				...
				if config_info.Play.Enable_languages != 0 {
					...
					act(&blah[0], 1, ch, nil, unsafe.Pointer(f.Follower), int(TO_VICT|2<<7))
				}
			}
		}
...
func is_tell_ok(ch *char_data, vict *char_data) bool {
	if ch == vict {
		...
		act(libc.CString("$E's linkless at the moment."), 0, ch, nil, unsafe.Pointer(vict), int(TO_CHAR|2<<7))
	} else if PLR_FLAGGED(vict, PLR_WRITING) {
		act(libc.CString("$E's writing a message right now; try again later."), 0, ch, nil, unsafe.Pointer(vict), int(TO_CHAR|2<<7))
	} else if !IS_NPC(vict) && ch.Admlevel < 1 && PRF_FLAGGED(vict, PRF_NOTELL) || ROOM_FLAGGED(vict.In_room, ROOM_SOUNDPROOF) {
		act(libc.CString("$E can't hear you."), 0, ch, nil, unsafe.Pointer(vict), int(TO_CHAR|2<<7))
	} else {
		return true
	}
	return false
...
func do_tell(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if !IS_NPC(ch) {
		...
		for k = descriptor_list; k != nil; k = k.Next {
			...
			if found == 0 && !IS_NPC(ch) && (libc.StrCaseCmp(k.User, &buf[0]) == 0 || libc.StrStr(k.User, &buf[0]) != nil) {
				vict = k.Character
				found = 1
			} else if !IS_NPC(ch) && found == 0 && (libc.StrCaseCmp(GET_NAME(k.Character), &buf[0]) == 0 || libc.StrStr(GET_NAME(k.Character), &buf[0]) != nil) && k.Character.Admlevel > 0 {
				vict = k.Character
				found = 1
			}
		}
...
func do_spec_comm(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if buf[0] == 0 || buf2[0] == 0 {
		...
		act(&buf1[0], 0, ch, nil, unsafe.Pointer(vict), TO_VICT)
		if !IS_NPC(ch) && PRF_FLAGGED(ch, PRF_NOREPEAT) {
			send_to_char(ch, libc.CString("%s"), config_info.Play.OK)
		} else {
			var blum [2048]byte
			stdio.Sprintf(&blum[0], "@WYou %s @C$N@W, '@m%s@W'@n\r\n", action_sing, &buf2[0])
			act(&blum[0], 1, ch, nil, unsafe.Pointer(vict), TO_CHAR)
		}
		if subcmd == SCMD_WHISPER {
			act(action_others, 0, ch, nil, unsafe.Pointer(vict), TO_NOTVICT)
...
func do_write(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if obj != nil {
		...
		act(libc.CString("$n begins to write a note on $p."), 1, ch, obj, nil, TO_ROOM)
		return
	}
	papername = &buf1[0]
	penname = &buf2[0]
	...
	if int(pen.Type_flag) != ITEM_PEN {
		act(libc.CString("$p is no good for writing with."), 0, ch, pen, nil, TO_CHAR)
	} else if int(paper.Type_flag) != ITEM_NOTE {
		act(libc.CString("You can't write on $p."), 0, ch, paper, nil, TO_CHAR)
	} else {
		...
		act(libc.CString("$n begins to jot down a note."), 1, ch, nil, nil, TO_ROOM)
	...
	if IS_NPC(ch) {
			...
			if ADM_FLAGGED(ch, ADM_TELLALL) {
				for d = descriptor_list; d != nil; d = d.Next {
					if d.Connected == CON_PLAYING && d.Character != nil {
						act(&buf[0], 0, ch, nil, unsafe.Pointer(d.Character), TO_VICT)
					}
				}
			} else {
		...
		if (func() *char_data {
			...
			if PRF_FLAGGED(ch, PRF_NOREPEAT) {
				...
				act(&buf[0], 0, ch, nil, unsafe.Pointer(vict), TO_CHAR)
			}
		} else {
...
func do_gen_comm(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if !IS_NPC(ch) && PRF_FLAGGED(ch, uint32(int32(channels[subcmd]))) {
	...
	for i = descriptor_list; i != nil; i = i.Next {
		if i.Connected == CON_PLAYING && i != ch.Desc && i.Character != nil && (IS_NPC(i.Character) || !PRF_FLAGGED(i.Character, uint32(int32(channels[subcmd])))) && (IS_NPC(i.Character) || !PLR_FLAGGED(i.Character, PLR_WRITING)) && !ROOM_FLAGGED(i.Character.In_room, ROOM_SOUNDPROOF) {
			...
			msg = act(&buf1[0], 0, ch, nil, unsafe.Pointer(i.Character), int(TO_VICT|2<<7))
...
func do_qcomm(ch *char_data, argument *byte, cmd int, subcmd int) {
	...
	if *argument == 0 {
		...
		if PRF_FLAGGED(ch, PRF_NOREPEAT) {
			...
			act(&buf[0], 0, ch, nil, unsafe.Pointer(argument), TO_CHAR)
		} else {
			act(argument, 0, ch, nil, unsafe.Pointer(argument), TO_CHAR)
		}
		if subcmd == SCMD_QSAY {
