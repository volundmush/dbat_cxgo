...
func find_obj_in_list_vnum(head *obj_data, vn obj_vnum) *obj_data {
	for head != nil {
...
func find_obj_in_list_vnum_good(head *obj_data, vn obj_vnum) *obj_data {
	for head != nil {
...
func find_obj_in_list_flag(head *obj_data, flag bitvector_t) *obj_data {
	for head != nil {
